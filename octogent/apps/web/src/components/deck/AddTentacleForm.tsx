  ...
  return (
    <form className="deck-add-form" onSubmit={handleSubmit}>
      ...
      <div className="deck-add-form-body">
        ...
        <div className="deck-add-form-content">
          ...
          {availableSkills.length > 0 && (
            <div className="deck-add-form-label">
              <button
                type="button"
                className="deck-add-form-skills-toggle"
                onClick={() => setSkillsExpanded(!skillsExpanded)}
              >
                Suggested Skills {skillsExpanded ? "▲" : "▼"}
              </button>
              <div className={`deck-add-form-skills ${skillsExpanded ? "expanded" : "collapsed"}`}>
