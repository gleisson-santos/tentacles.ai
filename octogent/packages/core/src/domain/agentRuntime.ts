...
export type TerminalAgentProvider = "codex" | "claude-code" | "gemini-cli" | "tentacles-agent";

export const TERMINAL_AGENT_PROVIDERS: TerminalAgentProvider[] = ["codex", "claude-code", "gemini-cli", "tentacles-agent"];
